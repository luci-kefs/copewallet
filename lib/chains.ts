...
export const CHAINS: Chain[] = [
  ...
  { id: 59144, name: 'Linea',         shortName: 'LINEA',  symbol: 'ETH',   rpcEnvKey: 'PRIVATE_RPC_URL_LINEA',    explorerUrl: 'https://lineascan.build',        coingeckoId: 'ethereum',           color: '#61DFFF', isAlchemy: true,  logoUrl: `${CG}/28206/small/ftxG9_TJ_400x400.jpeg`                  },
  ...
  { id: 1313161554, name: 'Aurora',   shortName: 'AURORA', symbol: 'ETH',   rpcEnvKey: 'PRIVATE_RPC_URL_AURORA',   explorerUrl: 'https://aurorascan.dev',         coingeckoId: 'ethereum',           color: '#78D64B', isAlchemy: false, logoUrl: `${CG}/20582/small/aurora.jpeg`                             },
  ...
  { id: 1101,  name: 'Polygon zkEVM', shortName: 'ZKEVM',  symbol: 'ETH',   rpcEnvKey: 'PRIVATE_RPC_URL_ZKEVM',    explorerUrl: 'https://zkevm.polygonscan.com',  coingeckoId: 'ethereum',           color: '#7B3FE4', isAlchemy: false, logoUrl: `${CG}/4713/small/polygon.png`                              },
